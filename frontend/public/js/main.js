// D:\Assignment\SEM 4\MBD\myits-collab\frontend\public\js\main.js
    ...
    try {
        ...
        projects.forEach(project => {
            ...
            projectCard.innerHTML = `
                ...
                <p><strong>Bidang:</strong> ${project.Nama_Bidang}</p> <p><strong>Uploader NIP:</strong> ${project.Dosen_NIP || project.Admin_ID_Admin || 'N/A'}</p> <button onclick="viewProjectDetails('${project.ID_Proyek}')">Details</button>
            `;
...
async function handleCreateProject(event) {
    ...
    const projectData = {
        ...
        Nama_Bidang: form.Nama_Bidang.value
    };
